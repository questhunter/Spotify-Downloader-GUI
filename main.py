...
class GUI:
    ...
    # BackGround
        ...
        self.dl_btn = tkinter.Button(root, image=self.dl_btn_img, borderwidth=0, bg='black', activebackground='black', command=lambda:threading.Thread(target=download.get_link(self)).start())
        ...
        self.pth_btn = tkinter.Button(root, image=self.pth_btn_img, borderwidth=0, bg='black', activebackground='black', command=set_path.get_path)
